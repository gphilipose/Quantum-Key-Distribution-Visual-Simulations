...
// getting n random bits symbolizing the bits from a quantum random number generator (QRNG)
// also used to generate random bases (that in theory Alice and Bob would choose)
// Bases: 0 --> + basis (rectilinear) and 1 --> x basis (diagonal)
...
function BB84(n, includeEve) {
    ...
    for (let i=0; i < n; i++) {
        ...
        // storing the bit recieved by Bob (either affectred or not affected by Eve and
...
// calulating the error rate between Bob and Alice's sifted key
